...
var launchCommand = &cli.Command{
	...
	Flags: []cli.Flag{
		&cli.StringFlag{
			...
			EnvVars: []string{strings.ToUpper(LXDSocket)},
		},
		&cli.StringFlag{
			...
			EnvVars: []string{strings.ToUpper(LXDServerAddress)},
		},
		&cli.StringFlag{
			Name:    ClientKeyPath,
			Aliases: []string{"k"},
			...
			EnvVars: []string{strings.ToUpper(ClientKeyPath)},
		},
		&cli.StringFlag{
			Name:    ClientCertPath,
			Aliases: []string{"c"},
			...
			EnvVars: []string{strings.ToUpper(ClientCertPath)},
		},
		&cli.StringFlag{
			Name:    InstanceType,
			Aliases: []string{"t"},
			...
			EnvVars: []string{strings.ToUpper(InstanceType)},
		},
		&cli.StringSliceFlag{
			Name:    InstanceProfiles,
			Aliases: []string{"p"},
			Usage:   "profiles will be applied to instances",
			EnvVars: []string{strings.ToUpper(InstanceProfiles)},
		},
		&cli.StringFlag{
			Name:    CPUResource,
			Aliases: []string{"rc"},
			...
			EnvVars: []string{strings.ToUpper(CPUResource)},
		},
		&cli.StringFlag{
			Name:    MemoryResource,
			Aliases: []string{"rm"},
			...
			EnvVars: []string{strings.ToUpper(MemoryResource)},
		},
		&cli.StringFlag{
			Name:     StoragePool,
			Aliases:  []string{"sp"},
			...
			EnvVars:  []string{strings.ToUpper(StoragePool)},
		},
		&cli.StringFlag{
			Name:     RootSize,
			Aliases:  []string{"rd"},
			...
			EnvVars:  []string{strings.ToUpper(RootSize)},
		},
		&cli.StringFlag{
			Name:    NetworkIngress,
			Aliases: []string{"ri"},
			...
			EnvVars: []string{strings.ToUpper(NetworkIngress)},
		},
		&cli.StringFlag{
			Name:    NetworkEgress,
			Aliases: []string{"re"},
			...
			EnvVars: []string{strings.ToUpper(NetworkEgress)},
		},
		&cli.Int64Flag{
			Name:    ProxyPort,
			Aliases: []string{"pp"},
			...
			EnvVars: []string{strings.ToUpper(ProxyPort)},
		},
		&cli.StringFlag{
			Name:    DeviceName,
			Aliases: []string{"dn"},
			...
			EnvVars: []string{strings.ToUpper(DeviceName)},
		},
		&cli.StringSliceFlag{
			Name:    InstanceEnvs,
			Aliases: []string{"e"},
			Usage:   "Instance environment, for example: ENV=production.",
			EnvVars: []string{strings.ToUpper(InstanceEnvs)},
		},
		&cli.StringFlag{
			Name:    StartCommand,
			Aliases: []string{"sc"},
		...
		&cli.StringSliceFlag{
			...
			EnvVars: []string{strings.ToUpper(MountFiles)},
		},
		&cli.Int64Flag{
			Name:    ExposePort,
			Aliases: []string{"ep"},
		...
		&cli.BoolFlag{
			...
			EnvVars: []string{strings.ToUpper(RemoveExisting)},
		},
		&cli.Int64Flag{
			Name:    StatusPort,
			Aliases: []string{"stp"},
			...
			EnvVars: []string{strings.ToUpper(StatusPort)},
		},
	},
