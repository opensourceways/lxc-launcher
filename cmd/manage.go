...
var manageCommand = &cli.Command{
	...
	Flags: []cli.Flag{
		...
		&cli.Int64Flag{
			...
			EnvVars: []string{strings.ToUpper(ImageWorker)},
		},
		&cli.Int64Flag{
			Name:    SyncInterval,
			Aliases: []string{"si"},
			...
			EnvVars: []string{strings.ToUpper(SyncInterval)},
		},
		&cli.StringFlag{
			Name:    MetaEndpoint,
			Aliases: []string{"m"},
			Usage:   "endpoint for images metadata",
			EnvVars: []string{strings.ToUpper(MetaEndpoint)},
		},
		&cli.StringFlag{
			Name:    RegistryUser,
			Aliases: []string{"u"},
			Usage:   "docker registry user",
			EnvVars: []string{strings.ToUpper(RegistryUser)},
		},
		&cli.StringFlag{
			Name:    RegistryPassword,
			Aliases: []string{"p"},
			Usage:   "docker registry password",
			EnvVars: []string{strings.ToUpper(RegistryPassword)},
		},
		&cli.BoolFlag{
			...
			EnvVars: []string{strings.ToUpper(ExitWhenUnready)},
		},
	},
